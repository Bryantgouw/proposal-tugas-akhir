...
% --- Ubah nama daftar listing ke "DAFTAR FORMULA" ---
% --- Harus diletakkan sebelum \begin{document} ---
\renewcommand{\lstlistlistingname}{\centering\normalsize DAFTAR FORMULA} 
\renewcommand{\lstlistingname}{Formula}
...
\begin{center}
    ...
    {\Large\bfseries Perancangan Desain Interaksi Inklusif Aplikasi AYO TOKO bagi Pengguna Dewasa Madya di Kota Bandung}\\
     \vspace{4cm}
